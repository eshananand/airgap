...
> Airgap auto-routing is now active for this project. Your natural language requests will automatically use airgap workflows. You can still use explicit `/command` invocations anytime. Run `/deactivate` to remove.
